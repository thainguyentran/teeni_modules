...
class ReturnPickingLine(models.TransientModel):
    _name = "teeni.stock.return.picking.line"
    ...
    wizard_id = fields.Many2one('teeni.stock.return.picking', string="Wizard")
    move_id = fields.Many2one('stock.move', "Move")


class ReturnPicking(models.TransientModel):
    _name = 'teeni.stock.return.picking'
    _description = 'Return Picking'

    picking_id = fields.Many2one('stock.picking')
    product_return_moves = fields.One2many('teeni.stock.return.picking.line', 'wizard_id', 'Moves')
    ...
    def default_get(self, fields):
        ...
        if picking:
            ...
            if picking.state not in ['done','s_rejected']:
                raise UserError(_("You may only return Done or Store Rejected pickings."))
